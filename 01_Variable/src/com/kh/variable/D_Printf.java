...
public class D_Printf {
	...
	/*
	 * System.out.println(출력하고자 하는 값); => 값을 출력하고 + 줄바꿈(개행)까지 넣어줌
	...
	public void printFtest() {
		...
		System.out.printf("%-5d \n", iNum1); // %-5 : 5칸의 공간 중 왼쪽 정렬

		// 실수 테스트
		double dNum = 4.27546789;
		System.out.printf("dNum : %f \n", dNum);
		// %f : 소수점 아래 7번째 줄에서 반올림 되어 소수점 아래 6번째 까지만 출력됨
		...
		// 단, 지정한 포맷의 갯수와 종류, 뒤에 오는 변수의 갯수와 종류가 정확하게 일치해야 함
