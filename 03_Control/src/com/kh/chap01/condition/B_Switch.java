...
public class B_Switch {
	 ...
	 *  // 브레이크문이 없다면 이 아래 코드도 계속 실행됨
	 * case 값2 : 실행할 코드2;
	 *           break;
	 * case 값n : 실행할 코드n;
	 *           break;
	 * ...
	 * default : 실행할 코드; // if ~ else 문에서 else와 같은 역할
	 *                     // 위의 값1, 값2, 값n... 앞으로 동등비교를 할 대상과 하나도 일치하지 
	 *                     // 않다면, default내의 실행할 코드가 실행됨
	 * }
	 * 
	...
	// switch문의 case는 책갈피 같음. 위에서 부터 차례대로가 아니라 걔만 실행. case가 천개가 있어도 연산속도 동일.
...
//		}
	...
	public void method2() {
		...
		System.out.print("과일(사과, 바나나, 복숭아) : ");
		...
		// XX의 가격은 XXXX원 입니다.
		System.out.printf("%s의 가격은 %d원입니다.", str, price);
	}
