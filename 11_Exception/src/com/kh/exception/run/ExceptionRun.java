...
public class ExceptionRun {
	...
	public static void main(String[] args) {
		 ...
		 * - 런타임 에러 : 소스코드상으로는 문제가 없는데 프로그램 실행 중 발생하는 오류
		 *              => 사용자의 잘못일 수도 있고 개발자가 예측해야하는데 하지 못한 경우
		 * - 논리 에러 : 소스코드상으로 문제 없고, 실행했을 때도 에러가 발생하지 않지만, 의도한대로 결과가 나오지 않는 경우
		 * 
		 * 시스템 에러를 제외한 컴파일 에러, 런타임 에러, 논리 에러와 같은 비교적 덜 심각한 것들을 가지고 작업을 함
		 * 이런 것들을 "예외"라고 부름(Exception)
		 * 
		 * 이런한 예외들이 발생했을 경우에 대비해서 처리하는 방법을 정의해 두는 것을 "예외처리"라고 한다.
		 * 
