...
public class FieldTest3 {
	 ...
	 * 자주 사용하는 변수, 메소드를 static으로 선언함
	 * 생성시점 : 프로그램 실행과 동시에 메모리의 static영역에 할당됨(굳이 객체를 생성하지 않아도 할당됨)
	 * 소멸시점 : 프로그램 종료시
	 */
	 ...
	 * 
	 * 값이 변경 되어서는 안되는 고정적인 값을 메모리상에 올려두고(프로그램 실행과 동시에 메모리 영역에 할당, 값이 변하지 않음)
	 * 공유하면서 사용할 목적으로 사용함
	 * ex) Math.PI;
	 * **상수명은 항상 모두 대문자로 변수명을 작성함
	 */
